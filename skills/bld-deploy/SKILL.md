---
name: bld-deploy
description: Deploy an app in this workspace to a private GitHub repo + Vercel with auto-deploy on push. Use when the user says /bld-deploy, "deploy this", "put this online", or "get me a share link".
---
...
> Note: `git push` already redeploys — you do **not** run `/bld-deploy` after every
