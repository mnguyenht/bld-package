...
animation, and craft passes belong to `/bld-refine`.
...
(full impeccable critique, review-animations gate) still live in `/bld-refine`
regardless of tier.
...
- Make it as good as the chosen time budget allows — never a deliberately bare
  ...
  The exhaustive strict craft passes still belong to `/bld-refine`.
