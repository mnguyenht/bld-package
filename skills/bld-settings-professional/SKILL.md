...
description: 'confp: Switch BLD command names between friendly and pro mode (which word comes first). Use for "pro mode", "shorter commands", "go back to the long names", or which naming mode is on.'
---
