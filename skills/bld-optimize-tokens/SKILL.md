...
- **over ~93%, or `forecast.minutes_remaining` under ~15** — say so *before* starting
  ...
  - **route the build work to Codex** (`/bld-agents`) — it spends the ChatGPT Plus
  ...
  - **or `/bld-handoff`** if the sprint is genuinely mid-flight — a handoff written
